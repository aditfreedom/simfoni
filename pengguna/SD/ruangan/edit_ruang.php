...
<div class="row">
	<div class="col-md-6">
		...
		<?php 
			if (isset($_POST['ubah']))
			{
				$peminjaman->ubah_peminjaman($_POST['id_ruang'], $_POST['id_status'], $_POST['id_jenjang'], $_POST['id_guru'], $_POST['id_hari'], $_POST['waktu_1'], $_POST['jam'], $_POST['jam_selesai'], $_POST['keperluan'], $_GET['id_peminjaman']);
